...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--model", default="fasterrcnn_CPresnet50_fpn", type=str, help="model name")
    ...
    parser.add_argument(
        "-dr", "--decompose-rank", type=int, default=1, help="use pre-specified rank to decompose all layers"
    )
    parser.add_argument(
        "-cpr", "--compress_rate", type=str, default="[0.]*100", help="list of compress rate of each layer"
    )
