...
def get_args_parser(add_help=True):
    ...
    parser.add_argument(
        "--model", default="fasterrcnn_CPresnet50_fpn", type=str, help="model name"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="use pre-specified rank to decompose all layers",
    )
    parser.add_argument(
        "-cpr",
        "--compress_rate",
        type=str,
        default="[0.]+[0.1]*2+[0.4]*5+[0.75]*12",
...
def main(args):
    ...
    if args.custom:
        ...
        model = eval(args.model)(
            weights=args.weight, compress_rate=compress_rate, rank=args.decompose_rank
        )
    else:
